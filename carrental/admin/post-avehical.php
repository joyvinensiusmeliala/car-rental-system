...
echo "
		<script>
		alert('Selamat Data Mobil Berhasil Ditambahkan!');
...
<?php 
$username=$_SESSION['UserName'];
$ret="SELECT id,BrandName,UserName FROM tblbrands WHERE UserName='$username'";
