...
from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand order by id desc limit 4";
...
// $sql = "SELECT * from tblreadybook 
// join tblvehicles on tblreadybook.id_mobil=tblvehicles.id
// join tblbrands on tblvehicles.VehiclesBrand=tblbrands.id order by tblreadybook.id DESC limit 4";
