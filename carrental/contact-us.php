...
<!-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAlgn-r6DKOkBHNGx5Tzff4_OkdJThulQ0&callback=initMap"></script>

<script>
    function initMap(){
            var map = new google.maps.Map(document.getElementById('map'),{
            center:new google.maps.LatLing(3.468740, 99.145897),
            zoom: 8
        }); 
      }
</script> -->
          <ul>
            ...
            <li>
              <!-- <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m" id="map" style="width:100%; height:700px;"></div> -->
                <!-- <div class="contact_info_m"> Maps Andos Rent Car </div> -->
                <script
              src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDcwGyRxRbcNGWOFQVT87A1mkxEOfm8t0w&callback=initMap&v=weekly"
              async></script>

                <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                <div class="contact_info_m" id="map" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDcwGyRxRbcNGWOFQVT87A1mkxEOfm8t0w&callback=initMap&v=weekly">Maps Andos Rent Car</div>
